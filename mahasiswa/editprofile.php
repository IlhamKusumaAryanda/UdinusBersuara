...
<body>
      ...
      <div class="profile_mahasiswa">
        <div class="name">
          ...
          <ul>
            ...
            <li><a href="dashboardmahasiswa.php">Profile Saya</a></li>
  ...
  <main style="margin-top: 60px;">
    <div class="container" style="color: #5E7C60; margin-top: 180px;">
      ...
      <form action="" method="post">
        ...
        <input type="text" name="kelas" value="<?php echo $_SESSION['nim']['kelas']; ?>" id="kelas" />
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE mahasiswa SET nama='$nama', nim='$nim', password='$password', kelas='$kelas' WHERE nim='$nim'";

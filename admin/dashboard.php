  ...
  <main>
    <div class="container">
      ...
      <div class="buttonTambahDataSiswa">
        <div>
          <button><a href="datamahasiswa.php" style="text-decoration: none; color: white;"><i class="fa-solid fa-user"></i> Data Semua Siswa</a></button>
        </div>
        <div>
      ...
      <form id="search">
        <div class="category_search">
          ...
          <span>
            <input type="checkbox" name="kemahasiswaan" id="kemahasiswaan">
            <label for="kemahasiswaan" class="kemahasiswaan">Kemahasiswaan</label>
          </span>
          <span>

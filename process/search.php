...
$terkirim = $conn->query("SELECT * FROM laporan,mahasiswa,kategori,status_laporan WHERE laporan.keluhan LIKE '%$keyword%' and status_laporan.status='terkirim' and status_laporan.id_status=laporan.id_status and laporan.nim=siswa.nim and laporan.id_kategori=kategori.id_kategori");
